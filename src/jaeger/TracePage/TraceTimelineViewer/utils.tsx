 ...
 */
export function spanHasTag(key: string, value: string | boolean, span: any) {
...
export const isErrorSpan = (span: any) => isErrorBool(span) || isErrorStr(span);
 ...
 */
export function spanContainsErredSpan(spans: any[], parentSpanIndex: number) {
 ...
 */
export function findServerChildSpan(spans: any) {
...
export const isKindClient = (span: any): boolean =>
  span.tags.some(({ key, value }) => key === 'span.kind' && value === 'client');

export const isKindProducer = (span: any): boolean =>
