  ...
  >
    ...
    >
      <div class="trace-name text-body2 text-bold">
        <span class="q-mr-xs"> {{ item.service_name }}ddd:</span>
        {{ item.operation_name }}
      </div>
        ...
        <template v-for="(count, service) in item.services" :key="service">
          ...
          >
            <div
              ...
              :style="{
                width: '14px',
                backgroundColor: 'rgb(183, 136, 94)',
              }"
            ></div>
...
const props = defineProps({
  item: {
    type: Object,
    default: () => ({
    "trace_id": "26a749acb7bc5d4180786c22c603f9e3",
    "trace_start_time": 1727364671962000,
    "trace_end_time": 1727364672974237,
    ...
    "duration": 1012236,
    "services": {
        "nodejs-javascript-service": 4
    },
    "zo_sql_timestamp": 1727364671961999
}),
  },
  index: {
    type: Number,
...
const formatTimeWithSuffix = (us: number) => {
  if (us >= 1000 * 1000) {
